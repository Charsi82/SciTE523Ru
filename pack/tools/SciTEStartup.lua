...
dofile (props["SciteDefaultHome"].."\\tools\\goto_line.lua") -- under construction
...
AddEventHandler("OnMenuCommand", function(msg, source)
	if msg == IDM_COMPLETE then
		if props['GetCurrentWord']=='' then return true end
	end
end)

----[[ П О Л Ь З О В А Т Е Л Ь С К А Я  П А Н Е Л Ь ]]------------------------
