...
#ifdef RB_HFS
void SciTEWin::SetDocumentAt(BufferIndex index, bool updateStack)
{
	SciTEBase::SetDocumentAt(index, updateStack);
	if (props.GetInt("hide.filterstrip.on.switch.tab", 0))
...
#ifdef RB_FFNOE
			if (findWhat.empty()) return FALSE; //!-add-[find_in_files_no_empty]
#endif // RB_FFNOE
